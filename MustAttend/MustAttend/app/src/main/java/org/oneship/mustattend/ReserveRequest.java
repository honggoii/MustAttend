...
public class ReserveRequest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        num = getIntent().getIntExtra("num", num);
        ...
        accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //서버랑 연결
                new JSONTask1().execute("http://192.168.11.9:3000/acceptrespond");
                Toast.makeText(getApplicationContext(),"수락 버튼 눌림", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(ReserveRequest.this , OwnerMain.class);
                intent.putExtra("user_email",user_email); //intent로 다음 activity에 전달할 이메일
                //액티비티 시작!
                ReserveRequest.this.startActivity(intent);
            }
        });
        ...
        reject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //서버랑 연결
                new JSONTask2().execute("http://192.168.11.9:3000/rejectrespond");
                Toast.makeText(getApplicationContext(),"거절 버튼 눌림", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(ReserveRequest.this , OwnerMain.class);
                intent.putExtra("user_email",user_email); //intent로 다음 activity에 전달할 이메일
                //액티비티 시작!
                ReserveRequest.this.startActivity(intent);
